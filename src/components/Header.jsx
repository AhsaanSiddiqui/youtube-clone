          ...
          <div className="flex-1 max-w-2xl mx-8">
            <form onSubmit={handleSearch} className="relative">
              <input 
                ...
                className="w-full bg-gray-700 text-white placeholder-gray-400 px-4 py-2 rounded-full pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:bg-gray-600"
              />
