  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        'mono': ['JetBrains Mono', 'Fira Code', 'Cascadia Code', 'Roboto Mono', 'Consolas', 'Courier New', 'monospace'],
        'display': ['Poppins', 'ui-sans-serif', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', 'sans-serif'],
        'body': ['Poppins', 'ui-sans-serif', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', 'sans-serif']
      },
      colors: {
        primary: {
          50: '#faf5ff',
